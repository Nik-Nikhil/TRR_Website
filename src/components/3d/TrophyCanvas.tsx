...
export default function TrophyCanvas() {
  return (
    <div className="w-full h-[320px] md:h-[420px] rounded-3xl bg-gradient-to-br from-purple-900/50 via-black to-emerald-900/40 border border-purple-500/30 overflow-hidden">
