...
export default function Season1Standings() {
  ...
  const placementOrderAfterTop3: Team["id"][] = ["helm", "bazinga", "billy", "nabeel"];
  ...
  return (
    // match other seasons: dark bg so no strip above footer
          ...
          <table className="w-full border-spacing-0 text-sm">
            ...
            <tbody>
              {ordered.map((team) => {
                ...
                // match S2/S3/S4: compact rows, shared styling
                const baseRow =
