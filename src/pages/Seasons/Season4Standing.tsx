...
export default function Season4Standings() {
  ...
  const championId: Team["id"] = "future-s4";      // 1st Place
  const runnerUpId: Team["id"] = "s1mpleo-s4";     // 2nd Place
  const thirdId: Team["id"] = "helm-s4";           // 3rd Place
  const dqId: Team["id"] = "none-s4";              // no real DQ; keeps logic consistent
